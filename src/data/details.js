export const cvData = {
    personalInfo: {
        ...
        contact: {
            phone: "+91 8539934869",
            email: "ruchipratihast99@gmail.com",
            github: "https://github.com/ruchipratihast",
    ...
    projects: [
        ...
        },
        {
            ...
            description: "Jobs Listing Application (frontend react+ backend mongodb)."
        }
    ],
    experience: [
        {
            ...
            points: [
                ...
                "Working with MongoDB to design and optimize scalable database schemas.",
                "Participating in sprint planning, code reviews, and continuous integration processes."
            ]
        },
        {
